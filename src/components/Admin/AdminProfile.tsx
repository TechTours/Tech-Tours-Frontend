...
const AdminProfile = () => {
    ...
    return ( 
        <div className="flex flex-col h-[100%] w-[100%]  justify-start items-center ">
           ...
           <div className='bg-white  w-[60%] shadow-md rounded-md p-4 flex space-y-4 flex-row justify-center items-center  '>
