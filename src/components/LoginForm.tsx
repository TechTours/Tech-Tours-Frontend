    ...
    return (
       <div className='w-[100%] h-[100%] bg-[#E5E5E5] flex flex-col justify-center items-center'>
          ...
          <div className='w-[70%] mt-5 mb-2 flex flex-row '>
            <div className=' w-[85%] flex flex-col justify-center items-center'>
                ...
                <div className='w-[100%] flex flex-col mb-5'>
                    ...
                    <input type="text" className='border-2xl w-[90%] h-10 rounded-md border-2 border-gray-300 bg-white pl-2 text-black ' />
                </div> 
          ...
          <div className='w-[78%] flex flex-row mb-5 justify-between'>
                    <div className='flex gap-1'> <input className='bg-white' type="checkbox" name="" id="" /> <p className='text-[#22543D]'> Remember me</p></div>
